...
function sizeGlobs() {
	if (window_width >= 1200) {
		$globOutline.animate({width: '140px', height: '140px', left: '0px', top: '0px'}, 1100, 'easeOutBounce');
	}
	else if (window_width >= 980) {
		$globOutline.animate({width: '140px', height: '140px', left: '0px', top: '0px'}, 1100, 'easeOutBounce', function() {$globOutline.css({width: '140px', height: '140px'});});
